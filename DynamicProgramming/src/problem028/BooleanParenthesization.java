 ...
 * Problem: Given a boolean expression with following symbols True and False, and the following operators filled between
 * symbols & | ^ AND OR XOR, count the number of ways we can parenthesize the expression so that the value of
 * expression evaluates to true.
 * Description: Please follow the link https://www.geeksforgeeks.org/boolean-parenthesization-problem-dp-37/
...
public class BooleanParenthesization {
    ...
    public static void main(String[] args)
    {
        ...
        // ((T|T)&(F^T)), (T|(T&(F^T))),
        // (((T|T)&F)^T) and (T|((T&F)^T))
        System.out.println(countParent(symbols,
                operators, n));
    }
}
