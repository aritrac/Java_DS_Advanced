 ...
 * Problem: Implement a simple trie data structure
 * Description: Refer to the code below
 */
public class Trie {
    ...
    public static void main(String[] args){
        ...
        t.addString("career");
        t.addString("careerm");
        t.addString("careermnk");
        System.out.println("Is careerm included? " + t.isEndOfString("careerm"));
        System.out.println("Is career included? " + t.isEndOfString("career"));
        System.out.println("Is caror included? " + t.isEndOfString("caror"));
    }
