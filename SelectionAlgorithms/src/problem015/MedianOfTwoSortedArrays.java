 ...
 * Problem: Given two arrays each containing n sorted elements, give an O(log n) time algorithm to find the median
 * of all 2n elements
 * Description: The simple solution to this problem is to merge the two lists and then take the average of the middle
 * two elements.But that would be of O(n) complexity. To get logn complexity, let median
 */
