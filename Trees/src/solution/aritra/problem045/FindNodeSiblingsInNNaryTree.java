package solution.aritra.problem045;

import solution.aritra.tree.defs.NNaryTreeNode;

/**
 * Author: Aritra Chatterjee
 * Problem: Given a node in a N-ary tree, find the number of siblings for that node
 * Description: For a given node in the tree, we just need to traverse all its next siblings
 */
public class FindNodeSiblingsInNNaryTree {
    public static void main(String[] args) {
        ...
        System.out.println("The sum of the N-nary tree = " + siblingsCount(level2Node2));
    }

    public static int siblingsCount(NNaryTreeNode current){
        int count = 0;
        while(current != null){
            count++;
